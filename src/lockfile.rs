...
/// Read the lock file
///
/// If the lock file does not exist, this function will create a new empty
/// Packages object, write a new lock file, and return this new Packages object.
///
/// If the lock file exists, this function will read the file content, try to
/// parse it into a Packages object, and return this object. If the parsing
/// fails, it will return an error.
pub fn read_snowlock() -> anyhow::Result<Packages> {
    let lock_file_path = expand_path(LOCK_FILE_PATH)?;

    // If the lock file does not exist, create a new Packages object and write a new
    // lock file
...
///
/// This function first checks and creates the necessary directories, then
/// converts the Packages object to TOML format, adds a comment stating that
/// this file is automatically generated and should not be manually changed, and
/// then writes the final content to the lock file.
///
/// If the Packages object cannot be converted to TOML format, this function
...
pub fn write_snowlock(packages: &Packages) -> anyhow::Result<()> {
    ...
    // Add a comment to explain that this file is automatically generated
...
///
/// This function achieves this by creating a new empty Packages object and
/// writing it to the lock file.
#[allow(dead_code)]
...
///
/// This function first gets the path of the lock file, then checks if the file
/// exists, if it does, it deletes it.
...
///
/// This function first gets the user's home directory, then uses the
/// shellexpand::tilde function to expand the path, and finally converts the
/// expanded path into a PathBuf object and returns it.
